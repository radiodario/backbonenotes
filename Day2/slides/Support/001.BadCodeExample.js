    ...
    window.trump = function() {
        ...
        function bindLiveEvents() {
            ...
            jQuery(".profileBtn").live("click", function(evt) {
                ...
                // Attach their photo
                jQuery("#profileSettings .ContactWrap").find("img").attr("src", "AtomImageEditor/imagehandler.aspx?id=" + marketer.AccountID).attr("width", "88");
            ...
            jQuery("div.triangle").live("click", function(evt) {
                ...
                var i = marketer.distanceLine.length; while (i--) {
                    ...
                    rolloverHTML += "<li id='t_" + tempMarketer.UniqueAccountID + "' class='" + marketer.distanceLine[i].color + " " + col + "'><div class='inner'><span class='Rank'>" + modifyStarRank(translateRank(tempMarketer.RankID)).replace(" Director", "") + "</span><div><img height='35' src='AtomImageEditor/imagehandler.aspx?id=" + tempMarketer.AccountID + "' />" +
        ...
        function ajaxComplete() {
            ...
            jQuery(".trumpit > img").modalize("#uplineModal");
            ...
            window.setTimeout(function() {
                ...
                jQuery.ajax({
                    ...
                    success: function(json) {
                        ...
                        for (var i = 0; i < matches.length; i++) {
                            jQuery("#uplineModal .UplineList").append("<li class='" + ((i % 2) ? "even" : "odd") + "'><img src='AtomImageEditor/imagehandler.aspx?id=" + matches[i].AccountID + "' alt='Profile Image' />" +
        ...
        function setSelectedInfo(marketer, selected, color, pinned, overflowed) {
            ...
            $yourGoalsMarker.find("#selectedProfilePic").attr("src", "AtomImageEditor/imagehandler.aspx?id=" + marketer.AccountID).attr("width", "55").attr("height", "55");
        ...
        function updateMiddleColumn(marketer, selectedMarketer, color) {
            ...
            if (recommendedList.length > requiredRanksLength) {
                ...
                for (i = original; i < additional; i++) {
                    ...
                    bottomHTML += "<li id='t_" + tempMarketer.UniqueAccountID + "' class='gray'><div class='inner'><span class='Rank'>" + modifyStarRank(translateRank(tempMarketer.RankID, true)).replace(" Director", "") + "</span><div><img height='35' src='AtomImageEditor/imagehandler.aspx?id=" + tempMarketer.AccountID + "' />" +
								"</div><strong>" + convertNameToFirstLast(tempMarketer.AccountName).substring(0, 12) + "<br />CGV " + formatComma(+tempMarketer.cgv) + "</strong></div></li>";
                }
        ...
        function updateRightColumn(marketer) {
            ...
            if (recommendedList.length > requiredRanksLength) {
                ...
                for (i = original; i < additional; i++) {
                    ...
                    bottomHTML += "<li id='t_" + tempMarketer.UniqueAccountID + "' class='gray'><div class='inner'><span class='Rank'>" + modifyStarRank(translateRank(tempMarketer.RankID, true)) + "</span><div><img height='35' src='AtomImageEditor/imagehandler.aspx?id=" + tempMarketer.AccountID + "' />" +
								"</div><strong>" + convertNameToFirstLast(tempMarketer.AccountName).substring(0, 12) + "<br />CGV " + formatComma(+tempMarketer.cgv) + "</strong></div></li>";
                }
        ...
        function rightColDrop(evt, ui) {
            ...
            if (ui.draggable.attr("id").substring(0, 1) === "t") {
                ...
                dropBoxItem = jQuery("<li id='t_" + dropMarketer.UniqueAccountID + "' class='gray'><div class='inner'><span class='Rank'>" + modifyStarRank(translateRank(dropMarketer.RankID, true)) + "</span><div><img height='35' src='AtomImageEditor/imagehandler.aspx?id=" + dropMarketer.AccountID + "' />" +
        ...
        function yourGoalsMarkerDrop(evt, ui) {
            ...
            // For the triangle rollover marketers
                ...
                var dropBoxItem = jQuery("<li id='t_" + selectedMarketer.UniqueAccountID + "' class='gray'><div class='inner'><span class='Rank'>" + modifyStarRank(translateRank(selectedMarketer.RankID, true)) + "</span><div><img height='35' src='AtomImageEditor/imagehandler.aspx?id=" + selectedMarketer.AccountID + "' />" +
        ...
        function createBoxItem(marketer, col, color, triangle, pinned) {
            ...
            //"<h1><span class='name'>" + accountName + "</span><br /><span class='cgvtest'>CV: " + formatComma(marketer.TotalComVol) + "</span>&nbsp;<span class='cgvtest'>CGV: " + formatComma(marketer.cgv) + "</span></h1>" +
				...
				"<div class='image'><img width='" + width + "' height='" + width + "' src='AtomImageEditor/imagehandler.aspx?id=" + marketer.AccountID + "' /></div>" +
        ...
        */
        ...
        return {
            ...
            "init": function(path) {
                ...
                jQuery(".trumpit > img").click(upline);
