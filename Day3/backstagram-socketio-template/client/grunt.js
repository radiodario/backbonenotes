...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    server: {
      ...
      release: {
        ...
        folders: {
          "app": "release/debug",
          "app/styles" : "release/debug",
          "app/img" : "release/debug",
          "vendor/js/libs": "release/debug"
        }
      }
    },
  ...
  grunt.registerTask("build", "copy:release copy:debug targethtml:release");
  ...
  grunt.registerTask("debug", "clean lint jst requirejs concat styles copy:debug targethtml:debug");
