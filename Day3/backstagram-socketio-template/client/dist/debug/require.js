...
define('jquery', ['jquery/dist/jquery'], function (main) { return main; });
...
(function (root, factory) {
   if (typeof define === "function" && define.amd) {
      ...
      define('Backbone.localStorage/backbone.localStorage',["underscore","backbone"], function(_, Backbone) {
...
define('Backbone.localStorage', ['Backbone.localStorage/backbone.localStorage'], function (main) { return main; });
...
define("vendor/js/libs/vintageJS/src/vintage", function(){});
...
(function( window, navigator ) {
  ...
  navigator.getUserMedia = function( opts, callback, errback ) {
    ...
    // If no getUserMedia, bail out with the error callback.
    if ( !getUserMedia ) {
...
define("vendor/js/libs/navigator.getusermedia", function(){});
...
define('app',[
  ...
  "vendor/js/libs/vintageJS/src/vintage",

  // Rick Waldron's excellent getUserMedia normalization lib.
  "vendor/js/libs/navigator.getusermedia"
],
